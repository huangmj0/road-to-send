# v11 pass — entries 1–14

The first frontend enhancement queue, moved here on 2026-07-25 once all fourteen were `Done`. Entry numbers never restart, so the queue continued at 15. The only text added to the originals is the supersession sentence appended to entry 13's `Notes:`.
